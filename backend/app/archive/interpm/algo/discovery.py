...
from .filter import filter_ocel_by_object_id, filter_ocel_by_object_type
from .mapping import map_object_id_to_type, map_process_to_object_type, map_process_to_event_activity
from .data_extractor import get_object_types, get_processes, get_objects
...
def discover_process_node_graph(ocel: OCEL) -> Dict[str, Any]:
    ...
    process_object_type_mapping = map_process_to_object_type(ocel)
    object_id_type_mapping = map_object_id_to_type(ocel)
    process_event_activity_mapping = map_process_to_event_activity(ocel)
    ...
    for pro in filtered_ocels:
        ...
        ocel_re: DataFrame = filtered_ocels[pro]
